function [ options_default ] = quasi_Newton_BFGS_options(varargin)
    ...
    options_default.step_mode = 'linsearch'; 
    options_default.max_reg_iters = 10;
    ...
    if nargin > 0
        options = varargin{1};
        if isfield(options,'max_reg_iters')
            options_default.max_reg_iters = options.max_reg_iters;
        end
