function options_default = evalderiv_options(varargin)
...
%    varargin{1}.ratio              which is used to reduce h on each step (default: 0.5)
%    varargin{1}.min_steps          Minimum number of steps in h (default: 5)
%    varargin{1}.max_steps          Maximum number of steps in h (default: 100)
%    varargin{1}.threshold                 Terminate if last step worse than preceding by a factor of tf
%                                   (default: 2)
%
% --------------------------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
